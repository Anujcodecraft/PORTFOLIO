const socialLinks = [
  {
    ...
    url: "https://github.com/Anujcodecraft",
  },
  {
    name: "LinkedIn",
    icon: (
    ...
    url: "https://www.linkedin.com/in/anuj-gautam-277a64257/",
  },
  {
    name: "LeetCode",
    icon: (
    ...
    url: "https://leetcode.com/u/ag083519/",
  },
  {
    name: "GFG",
    icon: (
    ...
    url: "https://www.geeksforgeeks.org/user/ag083dc0n/",
  },
];

const SocialLinks = () => {
  return (
    <div className="fixed left-4 bottom-4 hidden md:flex flex-col space-y-4 z-50">
      {socialLinks.map((link, index) => (
        <a
          ...
          className="p-3 bg-secondary rounded-full text-gray-300 hover:text-white hover:bg-accent transition-all shadow-lg hover:shadow-accent/50"
